BASE_INVENTORY = {
    ...
    "Elixir": {"count": 0, "effect": "full_heal", "value": 0, "description": "Fully restores HP"}
}

# Class-specific starting inventories
CLASS_STARTING_INVENTORY = {
    "Warrior": {
        "Potion": {"count": 4, "effect": "heal", "value": 30, "description": "Heals 30 HP"},
        "Ether": {"count": 1, "effect": "heal", "value": 15, "description": "Heals 15 HP"},
        "Bomb": {"count": 1, "effect": "damage", "value": 40, "description": "Deals 40 damage"},
        "Elixir": {"count": 0, "effect": "full_heal", "value": 0, "description": "Fully restores HP"}
    },
    "Mage": {
        "Potion": {"count": 2, "effect": "heal", "value": 30, "description": "Heals 30 HP"},
        "Ether": {"count": 3, "effect": "heal", "value": 15, "description": "Heals 15 HP"},
        "Bomb": {"count": 2, "effect": "damage", "value": 40, "description": "Deals 40 damage"},
        "Elixir": {"count": 1, "effect": "full_heal", "value": 0, "description": "Fully restores HP"}
    },
    "Rogue": {
        "Potion": {"count": 3, "effect": "heal", "value": 30, "description": "Heals 30 HP"},
        "Ether": {"count": 2, "effect": "heal", "value": 15, "description": "Heals 15 HP"},
